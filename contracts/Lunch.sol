...
funtion getAvailable() public returns (uint) {
	
	return limit - numbOfAttendee;

}

function checkAttendance(address
people) public returns (bool) {
